...
const Welcome = () => {
  ...
  return (
    ...
    >
      <div className="w-4/6 h-3/5 py-16 flex justify-evenly items-center relative">
        <div className="w-full h-full flex justify-center flex-col">
          <h1 id="name" className="text-7xl font-bold duration-500 -translate-x-full opacity-0">Jonas Westh Nielsen</h1>
          <h2 id="title" className="text-4xl italic font-semibold duration-700 -translate-x-full opacity-0">Software Developer</h2>
          <h3 id="studies" className="text-xl italic text-accent duration-1000 -translate-x-full opacity-0">
            @
            <a
