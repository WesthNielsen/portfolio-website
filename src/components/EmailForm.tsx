...
const EmailForm = () => {
  ...
  return (
    ...
    >
      <input
        className=" bg-background/50 rounded-xl border border-text focus:border-accent focus:outline-none focus:ring-0 p-2 w-2/5"
        ref={nameRef}
        type="text"
      ...
      />
      <input
        className=" bg-background/50 rounded-xl border border-text focus:border-accent focus:outline-none focus:ring-0 p-2 w-2/5 my-8"
        ref={emailRef}
        type="email"
      ...
      />
      <textarea
        className=" bg-background/50 rounded-xl border border-text focus:border-accent focus:outline-none focus:ring-0 p-2 w-2/5 h-full"
        ref={textRef}
        placeholder="Your message"
      />
      <button
        className="w-2/5 my-4 group flex justify-center cursor-pointer "
        disabled={loading}
      >
